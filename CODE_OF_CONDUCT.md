...
reported privately to the maintainers using GitHub's **Private Vulnerability
Reporting** on this repository (Security → Report a vulnerability) — it doubles
as a confidential channel to the maintainers — or by direct message to a
maintainer on GitHub. All complaints will be reviewed and investigated promptly
and fairly.
...
1. **Correction** — Community Impact: Use of inappropriate language or other
   ...
   warning, providing clarity around the nature of the violation.
