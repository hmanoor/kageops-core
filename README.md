...
Prefer watching to reading? **[docs/how-to](docs/how-to/README.md)** has short
narrated screen-captures of the real app — starting with
[first launch & the setup wizard](docs/how-to/assets/ep01-first-launch-setup-wizard.mp4)
(1:55): presets, trust levels, keychain-stored API keys, and the budget kill-switch.
The videos are generated by an automated pipeline that drives the actual app,
so they're regenerated with the UI and can't go stale.
