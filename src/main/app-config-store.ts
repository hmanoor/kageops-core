...
const PRESET_TEMPLATES: Readonly<Record<PresetName, AppAgentConfig>> = {
    ...
    openrouter_budget: {
        agents: {
            ...
            blueprint: { model: 'openrouter/anthropic/claude-haiku-4.5',  provider: 'openrouter', fallbackModels: ['ollama/qwen3.5:9b'] },
            forge:     { model: 'openrouter/deepseek/deepseek-v4-flash',   provider: 'openrouter', fallbackModels: ['ollama/qwen3.5:9b'] },
    ...
    openrouter_standard: {
        agents: {
            ...
            vigil:     { model: 'openrouter/anthropic/claude-haiku-4.5',  provider: 'openrouter', fallbackModels: ['ollama/qwen3.5:9b'] },
            aegis:     { model: 'openrouter/google/gemini-2.5-flash',     provider: 'openrouter', fallbackModels: ['ollama/qwen3.5:9b'] },
            pixel:     { model: 'openrouter/google/gemini-2.5-flash',     provider: 'openrouter', fallbackModels: ['ollama/qwen3.5:9b'] },
            cipher:    { model: 'openrouter/anthropic/claude-haiku-4.5',  provider: 'openrouter', fallbackModels: ['ollama/qwen3.5:9b'] },
            herald:    { model: 'openrouter/google/gemini-2.5-flash',     provider: 'openrouter', fallbackModels: ['ollama/qwen3.5:9b'] },
        },
    },
};
