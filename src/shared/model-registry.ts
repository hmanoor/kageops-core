...
export const MODELS: readonly ModelDef[] = [
    ...
    {
        id: 'openrouter/anthropic/claude-haiku-3-5',
        provider: 'openrouter',
...
export const PRESETS: readonly PresetDef[] = [
    ...
    },
    {
        ...
        agentModels: {
            ...
            blueprint: 'openrouter/anthropic/claude-haiku-3-5',
            pixel:     'openrouter/google/gemini-2.5-flash',
            forge:     'openrouter/deepseek/deepseek-chat-v3',
            cipher:    'openrouter/anthropic/claude-haiku-3-5',
